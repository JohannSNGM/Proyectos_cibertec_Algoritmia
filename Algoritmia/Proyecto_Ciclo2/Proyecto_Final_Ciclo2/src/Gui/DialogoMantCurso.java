...
public class DialogoMantCurso extends JDialog implements ActionListener, ItemListener, MouseListener {
	...
	public static void main(String[] args) {
		try {
			DialogoMantCurso dialog = new DialogoMantCurso();

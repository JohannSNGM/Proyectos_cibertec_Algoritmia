...
public class DialogoReporVigente extends JDialog implements ActionListener {
	...
	public static void main(String[] args) {
		try {
			DialogoReporVigente dialog = new DialogoReporVigente();

...
public class DialogoConsMatricula extends JDialog implements ActionListener {
	...
	public static void main(String[] args) {
		try {
			DialogoConsMatricula dialog = new DialogoConsMatricula();

...
public class DialogoRegRetiro extends JDialog implements ItemListener, ActionListener, MouseListener {
	...
	public static void main(String[] args) {
		try {
			 DialogoRegRetiro dialog = new  DialogoRegRetiro();

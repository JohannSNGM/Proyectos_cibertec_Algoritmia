...
public class DialogoReporPorCurso extends JDialog implements ActionListener {
	...
	public static void main(String[] args) {
		try {
			DialogoReporPorCurso dialog = new DialogoReporPorCurso();

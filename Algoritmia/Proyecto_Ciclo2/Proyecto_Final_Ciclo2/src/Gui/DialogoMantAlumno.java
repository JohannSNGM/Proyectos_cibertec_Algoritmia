...
public class DialogoMantAlumno extends JDialog implements ItemListener, ActionListener, MouseListener {
	...
	public static void main(String[] args) {
		try {
			DialogoMantAlumno dialog = new DialogoMantAlumno();

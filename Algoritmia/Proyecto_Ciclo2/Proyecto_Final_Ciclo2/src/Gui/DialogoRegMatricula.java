...
public class DialogoRegMatricula extends JDialog implements ItemListener, ActionListener, MouseListener {
	...
	public static void main(String[] args) {
		try {
			DialogoRegMatricula dialog = new DialogoRegMatricula();

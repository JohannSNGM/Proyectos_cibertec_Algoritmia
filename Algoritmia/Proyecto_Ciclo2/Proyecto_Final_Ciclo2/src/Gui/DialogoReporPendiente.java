...
public class DialogoReporPendiente extends JDialog implements ActionListener {
	...
	public static void main(String[] args) {
		try {
			DialogoReporPendiente dialog = new DialogoReporPendiente();
